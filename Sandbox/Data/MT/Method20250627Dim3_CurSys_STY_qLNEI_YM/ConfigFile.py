...
class OptimisationSetup_class(object):
    def __init__(self):
        ...
        self.name = "STYBasedResinOptimisationOfUCS"

        # Set the tailored experiment:
        self.TailoredExperiment_str = "Method20250627Dim3"
        self.ResinDesignationUsed = "12C-STY"

        self.StockUPR1_UP1vsDeI_Constant_DecPct_flt = 0.72          # 70% UP1 (30% STY)             # j1
        self.StockI1_CSvsBP_Constant_DecPct_flt = 0.8               # 80% CS (20% BP)               # j2
        self.TargetMassOfIUPR1a11_Constant_g_flt = 3.0              # Target Mass of IUPR           # j3
        self.UPR1_StockUPR1vsDeI_Bounds_DecPct_lis = [0.45,1.00]    # 45-100% StockUPR1 (55-0% STY) # x1
        ...
        self.MetricOne_str = "ym"
        self.MetricOneDescription_str = "Young's Modulus (N/mm^-2)"
        self.Metrics_lis = [self.MetricOne_str]
        self.Objectives_str = f"{self.MetricOne_str}"
        self.ObjectivesType_str = "YoungsModulus"
